...
export default function AddBtn({productId}:{productId:string}) {
  ...
  <CardFooter className="flex justify-between">
      ...
      <Button onClick={()=>{addToWishList(productId)}}> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6">
